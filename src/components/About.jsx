...
const About = () => {
  ...
  return (
    <section id="about" className="py-5 px-2 sm:px-4 mb-15" ref={ref}>
  ...
  <div className="relative w-56 h-56 sm:w-72 sm:h-72 md:w-80 md:h-80 mx-auto lg:mx-0">
    ...
    {/* Image container */}
    <div className="relative rounded-full overflow-hidden w-full h-full shadow-[0_0_80px_rgba(255,255,255,0.6)]">
      <img
        src="src/assets/DG-pfp-for-portfolio.jpg"
        alt="Darshan Gowda"
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 via-indigo-600/10 to-transparent"></div>
          ...
          <animated.div style={fadeInRight} className="lg:col-span-2 space-y-4">
            <div className="liquid-glass-card p-6 sm:p-7 rounded-3xl">
              <div className="space-y-3 text-gray-300 leading-relaxed text-base sm:text-lg">
                ...
                <p>
                  I work primarily with the <strong className="text-purple-400">MERN stack</strong> and have built production-ready projects like a Petrol Bunk Management System and EduWorld platform. I'm skilled in <strong className="text-white">Python libraries for Data Science, AI, and ML</strong>, and I also develop <strong className="text-purple-400">Android apps using React Native</strong>. My expertise includes <strong className="text-white">PowerBI and Python visualization</strong> for creating compelling data insights.
                </p>
